...
import com.learn.microservices.shopeeorderservice.response.ErrorResponse;
import com.learn.microservices.shopeeorderservice.response.ValidationErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<?> handleGlobalException(OrderServiceException userException, Locale locale) {
	...
	protected ResponseEntity<?> handleFeignException(FeignException e, Locale locale) {
		return ResponseEntity.status(e.status()).body(ErrorResponse.builder().code(String.valueOf(e.status())).message(e.getMessage()).build());
	}
